...
<?php
    ...
    if($_SESSION['clientID'=="clientID"]){ //checks if user is logged in
    }
    else{
    header("location:jobpostings.php "); // redirects if user is not logged in
    }
?>
    ...
    <body>
        ...
        <div class = "container-fluid">
            ...
            //Display skill_id
                    ...
                    // CLIENT
                    if(isset($_SESSION['type']) && $_SESSION['type']=="client" && $_SESSION['clientID']=="client_id") {
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        while($row = mysqli_fetch_array($query)) {
                                            ...
                                            Print '<td align="center"><a href="editjob.php"('.$row['job_id'].')">Edit</a> </td>';         //For getting the developer's id
